...
def test_publish_full_projection_and_pointer(db, home):
    ...
    assert r.source_dataset_version == 1 and r.counts == {"assets": 5, "located": 4, "records": 0, "attachments": 0, "photos": 0}
...
def test_records_and_photos_after_import(db, home):
    ...
    assert r.outcome == "published" and r.counts == {"assets": 5, "located": 4, "records": 3, "attachments": 3, "photos": 2}
    out = home / r.output_dir
