...
- `test_j5_012_backup.py`: 백업·복구. 일관된 사본·manifest·포인터·로그·검증, 상태 표시, 참조 사진 누락·손상 시 백업 실패(이전 백업 유지), DB 사본 실패, 쓰기 트랜잭션 안 백업 거절·스냅샷 중 다른 쓰기 대기, 외부 위치 백업, 빈 폴더 복구와 기록 수·해시·사진 연결 대조, 비어 있지 않은 폴더·변조된 백업 거절, 사진 대사, CLI.
