...
- `calc/`: 계산기 입력 예제 6종 (J5-016A, 데이터 사전 §9~§10 가상 검증 사례): `far_gross`(검토 600·여유 360), `far_excluded`(A 90·검토 540·여유 300), `equity_gross`·`equity_net`(17억), `equity_unknown`(미출력), `cash_basic`(21억).
