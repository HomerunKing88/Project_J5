...
def test_apply_valid_package(db, home, tmp_path, form):
    ...
    st = db.status()
    assert st["ok"] and st["counts"] == {"subjects": 5, "assets": 5, "source_documents": 1, "records": 3, "record_evidence": 3, "attachments": 3, "survey_units": 0, "survey_sessions": 0, "unit_observations": 0, "parcels": 0, "asset_components": 0, "collection_runs": 0, "transaction_observations": 0, "transactions": 0, "transaction_links": 0, "review_decisions": 0, "zone_rules": 0}
